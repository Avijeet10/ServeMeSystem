...
public class RequestLists extends AppCompatActivity {
    ...
    public static final String EXTRA_TEXT="com.example.myapplication.EXTRA_TEXT";
    private static final String TAG = "RequestLists";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String vendoremail = FirebaseAuth.getInstance().getCurrentUser().getEmail().toString();
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (search.equals("Requested") && vendoremail.equals(getvendoremail) ) {
                        vendorList.add(user);
                        count++;
                    }
                }
                ...
                */
                ...
                RequestListsAdapter adapter = new RequestListsAdapter(RequestLists.this, R.layout.activity_request_lists, vendorList);
