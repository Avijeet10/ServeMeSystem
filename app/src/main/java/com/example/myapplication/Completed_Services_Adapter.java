...
public class Completed_Services_Adapter extends ArrayAdapter<Transaction_Handler> {

    private static final String TAG="Completed_Services_Adapter";
    private Context mContext;
    int mResource;
    private TextView name1,name2,name3,name4,name5;

    public Completed_Services_Adapter(@NonNull Context context, int resource, @NonNull ArrayList<Transaction_Handler> objects) {
