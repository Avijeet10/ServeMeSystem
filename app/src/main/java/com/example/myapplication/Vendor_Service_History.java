...
public class Vendor_Service_History extends AppCompatActivity {
    public static final String EXTRA_TEXT="com.example.myapplication.EXTRA_TEXT";
    private static final String TAG = "Vendor_Service_History";
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull final DataSnapshot dataSnapshot) {
                for (DataSnapshot ds : dataSnapshot.getChildren()) {
                    ...
                    if (search.equals("Paid") && customeremail.equals(getvendoremail) ) {
                        vendorList.add(user);
                        count++;
                    }
                }
                ...
                Vendor_Service_History_adapter adapter= new  Vendor_Service_History_adapter(Vendor_Service_History.this, R.layout.activity_user__order__history, vendorList);
                mListView.setAdapter(adapter);
                mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        String text=vendorList.get(position).getTransID().toString();
                        Intent intent=new Intent(Vendor_Service_History.this,VerifyierPopup.class);
