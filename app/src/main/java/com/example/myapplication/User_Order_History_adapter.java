...
public class User_Order_History_adapter extends ArrayAdapter<Transaction_Handler> {

    private static final String TAG="User_Order_History_adapter";
    private Context mContext;
    int mResource;
    private TextView name1,name2,name3,name4,name5;

    public User_Order_History_adapter(@NonNull Context context, int resource, @NonNull ArrayList<Transaction_Handler> objects) {
