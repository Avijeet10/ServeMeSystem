...
public class Display_Tutoring extends AppCompatActivity {
    public static final String EXTRA_TEXT="com.example.myapplication.EXTRA_TEXT";
    private static final String TAG = "Display-Tutoring";
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    finish();
                    startActivity(new Intent(Display_Tutoring.this,No_vendors_Available.class));
                }


                VendorListAdapter adapter = new VendorListAdapter(Display_Tutoring.this, R.layout.vendor_choosen_list, vendorList);
                mListView.setAdapter(adapter);
                mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        String text = vendorList.get(position).getEmail();
                        Intent intent=new Intent(Display_Tutoring.this,ServiceRequestForm_Tutoring.class);
