...
public class ServiceRequestForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String text= intent.getStringExtra(Display_Appliances.EXTRA_TEXT);
        ...
        SubmitReq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(ServiceRequestForm.this,"Agreement needs to be check for further processing",Toast.LENGTH_LONG).show();
