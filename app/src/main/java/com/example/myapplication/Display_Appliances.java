...
public class Display_Appliances extends AppCompatActivity {
    public static final String EXTRA_TEXT="com.example.myapplication.EXTRA_TEXT";
    private static final String TAG = "Display-Appliances";
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                {
                    finish();
                    startActivity(new Intent(Display_Appliances.this,No_vendors_Available.class));
                }


                VendorListAdapter adapter = new VendorListAdapter(Display_Appliances.this, R.layout.vendor_choosen_list, vendorList);
                ...
                mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent=new Intent(Display_Appliances.this,ServiceRequestForm.class);
