...
public class ServiceRequestForm_HomeRepair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String text= intent.getStringExtra(Display_HomeRepair.EXTRA_TEXT);
        ...
        SubmitReq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(ServiceRequestForm_HomeRepair.this,"Agreement needs to be check for further processing",Toast.LENGTH_LONG).show();
