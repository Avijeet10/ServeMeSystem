...
public class ServiceRequestForm_Tutoring extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String text= intent.getStringExtra(Display_Tutoring.EXTRA_TEXT);
        ...
        SubmitReq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(ServiceRequestForm_Tutoring.this,"Agreement needs to be check for further processing",Toast.LENGTH_LONG).show();
