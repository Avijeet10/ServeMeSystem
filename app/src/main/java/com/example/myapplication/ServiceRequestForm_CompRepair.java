...
public class ServiceRequestForm_CompRepair extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String text= intent.getStringExtra(Display_CompRepair.EXTRA_TEXT);
        ...
        SubmitReq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(ServiceRequestForm_CompRepair.this,"Agreement needs to be check for further processing",Toast.LENGTH_LONG).show();
