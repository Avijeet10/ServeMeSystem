...
public class ServiceRuestForm_Homecleaning extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String text= intent.getStringExtra(Display_HomeCleaning.EXTRA_TEXT);
        ...
        SubmitReq.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                {
                    Toast.makeText(ServiceRuestForm_Homecleaning.this,"Agreement needs to be check for further processing",Toast.LENGTH_LONG).show();
