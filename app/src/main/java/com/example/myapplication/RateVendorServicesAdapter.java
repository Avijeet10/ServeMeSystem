...
public class RateVendorServicesAdapter extends ArrayAdapter<Transaction_Handler> {

    private static final String TAG="RateVendorServicesAdapter";
    private Context mContext;
    int mResource;
    private TextView name1,name2,name3,name4,name5;

    public RateVendorServicesAdapter(@NonNull Context context, int resource, @NonNull ArrayList<Transaction_Handler> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String Status="Status: " + getItem(position).getStatus().toString()+ "  AMOUNT: $"+getItem(position).getPrice();
        ...
        name1=(TextView) convertView.findViewById(R.id.STATUS2);
        name2=(TextView) convertView.findViewById(R.id.VNAME2);
        name5=(TextView) convertView.findViewById(R.id.VADDRESS2);
        name3=(TextView) convertView.findViewById(R.id.DATETIME2);
        name4=(TextView) convertView.findViewById(R.id.MESSAGE2);


        name1.setText(Status);
        name2.setText(companyName);
        name3.setText(dateAndTime);
        name4.setText(Service);
        name5.setText(Vendoraddress);
