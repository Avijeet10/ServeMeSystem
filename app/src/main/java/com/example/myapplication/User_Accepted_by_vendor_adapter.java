...
public class User_Accepted_by_vendor_adapter extends ArrayAdapter<Transaction_Handler> {

    private static final String TAG="User_Accepted_by_vendor_adapter";
    private Context mContext;
    int mResource;
    private TextView name1,name2,name3,name4,name5;

    public User_Accepted_by_vendor_adapter(@NonNull Context context, int resource, @NonNull ArrayList<Transaction_Handler> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        String Price="Rate $"+getItem(position).getPrice();
        ...
        name1.setText(companyandMessage);
        name2.setText(Vendoraddress);
        name3.setText(vendoremailphone);
        name4.setText(Price);
